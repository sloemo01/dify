...
class WorkflowBasedAppRunner:
    ...
    def _get_graph_and_variable_pool_for_single_node_run(
        ...
        *,
        ...
        graph_config = self._normalize_container_ownership(source_graph_config.to_graph_config())
        ...
        selected_node_configs = [
            _WorkflowGraphNodeConfig.model_validate(node) for node in all_node_configs if node.get("id") in node_ids
        ]
